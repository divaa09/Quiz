...
public class Quiz extends JFrame implements ActionListener {
   ...
   Quiz(String name)
   {
    ...
    image.setBounds(0, 0, 1440, 392); // left, top, width, height
    add(image);
    
    //adding questions number
     qno= new JLabel();
   ...
   {
      if(count==2||count==4||count==6||count==8||count==10) //1 3 5 7 8
      {
   ...
   else  //submit
   {
    ...
    {
    if(user_ans[i][0].equals(answers[i]))
    {
       score +=10;
    }
    }
   ...
   public void paint(Graphics g) //when object is created paint function is automatically created
   {
    super.paint(g);
